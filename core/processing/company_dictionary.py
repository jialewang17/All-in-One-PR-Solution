...
class CompanyDictionary:
    ...
    def __init__(self, dictionary_path: str = None, save_to_file: bool = True):
        ...
        self.dictionary_path = dictionary_path or "core/processing/company_dictionary.json"
        ...
        try:
            ...
            if dict_path.exists():
                with open(dict_path, 'r', encoding='utf-8') as f:
                    ...
                    self.company_aliases = data.get('aliases', {})
                    print(f"✅ 已加载词典: {len(self.companies)} 个公司")
    ...
    def is_company(self, word: str) -> bool:
        ...
        if not word:
            return False
        return word in self.companies or word.lower() in self._companies_lower
    ...
    def exists(self, name: str) -> bool:
        ...
        return normalized in self.companies or normalized.lower() in self._companies_lower
