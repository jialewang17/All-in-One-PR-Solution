...
from pr_enhanced_rag import EnhancedPRGraphRAG, EnhancedPRVectorRAG
from pr_knowledge_manager import BrandKnowledgeManager
from pr_methodology_rules import MethodologyRulesManager, MethodologyRule
...
"""
        ...
        # 执行RAG查询
        if use_graph:
            answer = self.graph_rag.query(enhanced_question)
        else:
            answer = self.vector_rag.query(enhanced_question)
