...
**文件**: `core/pr_knowledge_manager.py`
...
**文件**: `core/pr_methodology_rules.py`
...
**文件**: `core/pr_feedback_collector.py`
...
**文件**: `core/pr_quality_evaluator.py`
...
**文件**: `core/pr_enhanced_rag_with_rlhf.py`
...
- `demos/demo_rlhf_system.py` - RLHF系统演示脚本
